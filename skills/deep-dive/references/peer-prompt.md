...
reviewed artifact. When you serialize the union verdict, **echo** those `*_sha256` fields verbatim at
the top level of that one JSON object (do not compute, alter, or invent them). `crucible verdict`
